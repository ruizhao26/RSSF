...
# CHAIRS_PATH = '/mnt/zhaorui/datasets/optical_flow_datasets/FlyingChairs/data'
# SINTEL_PATH = '/mnt/zhaorui/datasets/optical_flow_datasets/Sintel'
# HD1K_PATH = '/mnt/zhaorui/datasets/optical_flow_datasets/hd1k'
# KITTI_PATH = '/mnt/zhaorui/datasets/optical_flow_datasets/KITTI2015'

CHAIRS_PATH = '/raid/zhaorui/datasets/optical_flow_datasets/FlyingChairs/data'
SINTEL_PATH = '/raid/zhaorui/datasets/optical_flow_datasets/Sintel'
HD1K_PATH = '/raid/zhaorui/datasets/optical_flow_datasets/hd1k'
KITTI_PATH = '/raid/zhaorui/datasets/optical_flow_datasets/KITTI2015'
...
class MpiSintel(FlowDataset):
    def __init__(self, aug_params=None, split='training', root=SINTEL_PATH, dstype='clean',
...
class FlyingChairs(FlowDataset):
    def __init__(self, aug_params=None, split='training', root=CHAIRS_PATH):
...
class FlyingThings3D(FlowDataset):
    def __init__(self, aug_params=None, root='/mnt/zhaorui/datasets/optical_flow_datasets/FlyingThings3D', split='training', dstype='frames_cleanpass'):
...
class KITTI(FlowDataset):
    def __init__(self, aug_params=None, split='training', root=KITTI_PATH):
...
class HD1K(FlowDataset):
    def __init__(self, aug_params=None, root=HD1K_PATH):
